...
// Copyright (c) 2009-2012 The AardvarkCoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The AardvarkCoin/$1-%s The AardvarkCoin/' %s"
REGEX_CURRENT= re.compile("%s The AardvarkCoin" % year)
