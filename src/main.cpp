...
#if defined(NDEBUG)
# error "AardvarkCoin cannot be compiled without assertions."
#endif
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s ARK additional fees, %d delta bytes\n",
