...
###AardvarkCoin maintainers/release engineers, update (commit) version in sources
...
###Build and sign AardvarkCoin Core for Linux, Windows, and OS X:
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitcoin.org server
  into `/var/www/bin/aardvarkcoin-core-${VERSION}`

- Update bitcoin.org version

  - First, check to see if the AardvarkCoin.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the AardvarkCoin.org release
...
- Announce the release:
  ...
  - AardvarkCoin-development mailing list

  - Update title of #bitcoin on Freenode IRC

  - Optionally reddit /r/AardvarkCoin, ... but this will usually sort out itself
