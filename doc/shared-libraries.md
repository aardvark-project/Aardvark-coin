...
The purpose of this library is to make the verification functionality that is critical to AardvarkCoin's consensus available to other applications, e.g. to language bindings.
...
- [NAardvarkCoin](https://github.com/NicolasDorier/NAardvarkCoin/blob/master/NAardvarkCoin/Script.cs#L814) (.NET Bindings)
