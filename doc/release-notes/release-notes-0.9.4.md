AardvarkCoin Core version 0.9.4 is now available from:
...
this update is incompatible with the AardvarkCoin system and could lead to consensus
forks.

AardvarkCoin Core released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled AardvarkCoin Core

upgrade to AardvarkCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
