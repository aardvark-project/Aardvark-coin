AardvarkCoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/AardvarkCoin/bitcoin-0.8.4/
...
code, causing the AardvarkCoin-Qt or bitcoind process to crash.
...
Linux: clicking on aardvarkcoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of AardvarkCoin against Boost versions 1.50-1.52.
