AardvarkCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/AardvarkCoin/bitcoin-0.5.4/
...
Fix AardvarkCoin-Qt notifications under Growl 1.3.
Increase required age of AardvarkCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAardvarkCoin properly when installing AardvarkCoin-Qt over it. (Windows)
