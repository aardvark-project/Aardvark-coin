AardvarkCoin Core version 0.11.0 is now available from:

  <https://bitcoin.org/bin/aardvarkcoin-core-0.11.0/>
...
Block pruning allows AardvarkCoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that AardvarkCoin Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only AardvarkCoinAmountField
...
- #6116 `30dc3c1` [OSX] rename AardvarkCoin-Qt.app to AardvarkCoin-Core.app
