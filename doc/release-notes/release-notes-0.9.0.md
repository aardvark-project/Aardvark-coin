AardvarkCoin Core version 0.9.0 is now available from:
...
earlier versions of AardvarkCoin, then run the installer (on Windows) or just copy
over /Applications/AardvarkCoin-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the AardvarkCoin
...
Rebranding to AardvarkCoin Core
---------------------------

To reduce confusion between AardvarkCoin-the-network and AardvarkCoin-the-software we
have renamed the reference client to AardvarkCoin Core.
...
Using the standard "./autogen.sh; ./configure; make" to build AardvarkCoin-Qt and
...
- Rebrand to `AardvarkCoin Core`
- Move initialization/shutdown to a thread. This prevents "Not responding"
  messages during startup. Also show a window during shutdown.
- Don't regenerate autostart link on every client startup
- Show and store message of normal aardvarkcoin:URI
...
- Linux: Fix Gnome aardvarkcoin: URI handler
